...
//Nomor Surat
$nomor ='Nomor : SUB/'.$no["SUB"].'/BLN/'.$no["BLN"].'/THN/'.$no['THN'];
...
//Menampilkan Detail Mahasiswa dan Buku
...
$pdf->Ln(5);
//Penutup Surat
$txt = 'Mahasiswa tersebut sudah melakukan salah satu syarat untuk mendapatkan Surat Bebas Pustaka yaitu menyumbangkan buku Non Mapel Sejumlah (minimal) 1 eksemplar dengan detail Buku:  .';
$pdf->MultiCell(0, 5,$txt."\n", 0, 'J', 0, 2, '' ,'', true);
...
$pdf->MultiCell(0, 5,$txt."\n", 0, 'J', 0, 1, '' ,'', true);
$txt = 'Cetakan/Tahun';
$pdf->MultiCell(35, 5,$txt."\n", 0, 'J', 0, 0, 30 ,'', true);
$txt = ': '.$buku['cetakan'].'/'.$buku['tahun'];
$pdf->MultiCell(0, 5,$txt."\n", 0, 'J', 0, 1, '' ,'', true);
$pdf->Ln(5);
}
...
$pdf->MultiCell(0,5,'* Segera serahkan ke admin perpustakaan untuk di setujui.',0,'L',0,1,'',266,true);
