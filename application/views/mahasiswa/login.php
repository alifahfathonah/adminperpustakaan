...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/assetlogin/css/google-roboto-300-700.css" rel="stylesheet" />
</head>
                        ...
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <div class="card card-profile">
                                ...
                                <div class="card-content">
                                    <?=form_open($form_action,['class' => 'form-horizontal needs-validation'])?>
                                      ...
                                      <h3>Login Mahasiswa</h3>
                                        <div class="form-group">
                                            <div class="input-group has-feedback <?=setValidationStyle('email') ?>">
                                              ...
                                              <input type="email" class=" form-control" name="email" value="<?php echo $input->email ?>" placeholder="Email" style="border-radius: 0px 30px 30px 0px;" autofocus = 'autofocus' >
                                        ...
                                        <?php 
                                        $notif = $this->nativesession->get('captcha');
                                        
                                        if ( isset($notif) && $_SESSION['captcha'] >= 4) {  ?>
                                            
                                            
                                            <p><?=captchaLogin()['image'];?></p>
                                            <div class="form-group">
                                                <div class="input-group has-feedback <?=setValidationStyle('captcha');?>">
                                                    <div class="input-group-addon" style="border: 0px;padding: 2px 10px 0px 12px;border-radius: 30px 0px 0px 30px;background-color: #1b7fa1;color: #ffffff;"><i class="fa  fa-retweet "></i></div>
                                                    <input type="text" name="captcha" class="form-control" placeholder="Captcha" style="border-radius: 0px 30px 30px 0px;">
                                                    <?= setValidationIcon('captcha') ?>     
                                                </div>

                                            <?=form_error('captcha');?>
                                            </div>
                                        <?php } ?>
                                      <button type="submit" name="submit" class="btn" style="border-radius: 30px; background-color: #1b7fa1; width: 50%;">Login</button>
                                    </form>
